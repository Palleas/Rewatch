...
class Client: NSObject {
    ...
    func fetchEpisodesFromShow(showId: Int) -> SignalProducer<Episode, NSError> {
        let params = ["id": String(showId)]
    ...
    func fetchPictureForEpisodeId(id: String) -> SignalProducer<UIImage, NSError> {
        let request = requestForPath("pictures/episodes", params: ["id" : id, "width": "960", "height": "540"], method: "GET")
        return session
